...
if (!MONGODB_URI) {
    ...
    console.error('Set MONGODB_URI in your Render.com service Environment Variables before deploying.');
    process.exit(1);
}
...
const Course = mongoose.model('Course', new Schema({ name: String }));
...
// --- Single shared handler for the whole app ---
